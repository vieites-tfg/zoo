...
// The `KindID` scalar type represents an identifier for an object of type Kind.
type KindID string
...
// Retrieve the binding value, as type Kind
func (r *Binding) AsKind() *Kind {
	q := r.query.Select("asKind")
...
// Create or update a binding of type Kind in the environment
func (r *Env) WithKindInput(name string, value *Kind, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withKindInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired Kind output to be assigned in the environment
func (r *Env) WithKindOutput(name string, description string) *Env {
	q := r.query.Select("withKindOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
func (r *Kind) WithGraphQLQuery(q *querybuilder.Selection) *Kind {
	return &Kind{
		query: q,
	}
}

func (r *Kind) ClusterName(ctx context.Context) (string, error) {
	if r.clusterName != nil {
		return *r.clusterName, nil
	}
	q := r.query.Select("clusterName")
...
func (r *Kind) Container() *Container {
...
func (r *Kind) DockerSocket() *Socket {
	q := r.query.Select("dockerSocket")
...
// A unique identifier for this Kind.
func (r *Kind) ID(ctx context.Context) (KindID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Kind) XXX_GraphQLType() string {
	return "Kind"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Kind) XXX_GraphQLIDType() string {
	return "KindID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Kind) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Kind) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadKindFromID(KindID(id))
	return nil
}
...
func (r *Kind) Inspect() *Container {
	q := r.query.Select("inspect")
...
func (r *Kind) KindPort(ctx context.Context) (int, error) {
	if r.kindPort != nil {
		return *r.kindPort, nil
	}
	q := r.query.Select("kindPort")
...
func (r *Kind) KindSvc() *Service {
	q := r.query.Select("kindSvc")
...
func (r *Kind) Knines() *Container {
	q := r.query.Select("knines")
...
func (r *Kind) LoadContainerOnKind(container *Container, tag string) *Container {
	assertNotNil("container", container)
	q := r.query.Select("loadContainerOnKind")
...
// KindOpts contains options for Client.Kind
...
func (r *Client) Kind(dockerSocket *Socket, kindSvc *Service, opts ...KindOpts) *Kind {
	assertNotNil("dockerSocket", dockerSocket)
	assertNotNil("kindSvc", kindSvc)
	q := r.query.Select("kind")
	for i := len(opts) - 1; i >= 0; i-- {
		...
		// `kindSha` optional argument
		if !querybuilder.IsZeroValue(opts[i].KindSha) {
			q = q.Arg("kindSha", opts[i].KindSha)
		}
	...
	q = q.Arg("dockerSocket", dockerSocket)
	q = q.Arg("kindSvc", kindSvc)
...
// Load a Kind from its ID.
func (r *Client) LoadKindFromID(id KindID) *Kind {
	q := r.query.Select("loadKindFromID")
	q = q.Arg("id", id)
...
func (KindVersion) IsEnum() {}

const (
	KindVersionV13013 KindVersion = "v1_30_13"

	KindVersionV1319 KindVersion = "v1_31_9"

	KindVersionV1325 KindVersion = "v1_32_5"

	KindVersionV1331 KindVersion = "v1_33_1"
)
