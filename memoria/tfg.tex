...
\lstdefinelanguage{helm}{
  ...
  keywords={
    ...
    spec, status, data, port, number, appVersion,
    dependencies, version, repository, condition,
    ...
    rules, host, http, paths, path, pathType, serviceName,
  ...
  literate={
    ...
    {backend:}{{{\textcolor{blue}{backend:}}}}8
  }
}
...
\lstdefinelanguage{workflows}{
  ...
  keywords={
    ...
    workflow_dispatch, shell, working-directory, concurrency
  },
  keywordstyle=\color{blue}\bfseries,
  identifierstyle=\color{black},
  comment=[l]{\#},
  ...
  sensitive=true,
  literate={
    {env:}{{{\textcolor{blue}{env:}}}}4
  }
}

\lstdefinelanguage{helmfile}{
  alsoletter={-,.},
  keywords={
    repositories, environments, releases, namespaces, values,
    name, url, chart, version, namespace,
  },
  keywordstyle=\color{blue}\bfseries,
  sensitive=true,
  identifierstyle=\color{black},
  ...
  morestring=[b]",
  moredelim=[s][\color{purple}\bfseries]{\{\{}{\}\}},
  morekeywords={requiredEnv, quote, .Values, .Environment.Name},
...
\appendix
\cleardoublepage
\include{capitulos/manuales-tecnicos}
\cleardoublepage
\include{capitulos/manuales-usuario}
% \cleardoublepage
